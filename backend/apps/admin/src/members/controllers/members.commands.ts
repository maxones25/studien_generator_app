...
import { DirectorGuard } from '@admin/directors/infrastructure/http/guards/director.guard';
import { MemberQueryDto } from '@admin/studies/studies/dtos/MemberQueryDto';
import { Director } from '@admin/directors/infrastructure/http/decorators/director.decorator';
