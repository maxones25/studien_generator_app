...
describe('set form time independent', () => {
  let app: IApp;
  ...
  it('should set form time independent', async () => {
  ...
  it('should fail because form is already time independent', async () => {
    const formId = await createFormId(app, {
      accessToken,
      studyId,
    });
  ...
  it('should fail because unauthenticated', async () => {
    ...
    return await setFormTimeIndependent(app, {
